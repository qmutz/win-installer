    ...
    class XenPrepSupport
    {
        ...
        public static void CleanUpPVDrivers(bool workaround2k8 = false)
        {
            ...
            string[] hwIDs = {
                ...
                @"XENBUS\VEN_XCPngC000&DEV_IFACE&REV_00000001",
                @"XENBUS\VEN_XCPng0001&DEV_IFACE&REV_00000001",
                @"XENBUS\VEN_XCPng0002&DEV_IFACE&REV_00000001",
                @"XENBUS\VEN_XCPngC000&DEV_VBD&REV_00000001",
                @"XENBUS\VEN_XCPng0001&DEV_VBD&REV_00000001",
                @"XENBUS\VEN_XCPng0002&DEV_VBD&REV_00000001",
                @"XENVIF\VEN_XCPngC000&DEV_NET&REV_00000000",
                @"XENVIF\VEN_XCPng0001&DEV_NET&REV_00000000",
                @"XENVIF\VEN_XCPng0002&DEV_NET&REV_00000000",
                @"XENBUS\VEN_XCPngC000&DEV_VIF&REV_00000001",
                @"XENBUS\VEN_XCPng0001&DEV_VIF&REV_00000001",
                @"XENBUS\VEN_XCPng0002&DEV_VIF&REV_00000001",
                @"root\xenevtchn",
                @"XENBUS\CLASS&VIF",
